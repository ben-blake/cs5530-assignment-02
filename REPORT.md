...
This report summarizes the findings from the analysis performed for Question 1 and Question 2 of the assignment.
...
Several operations were performed to demonstrate data handling capabilities:
...
We compared the 98th percentile of BMI for the sample and the population.
...
The analysis demonstrates that while small single samples can provide rough estimates of central tendency (mean), they often fail to capture extremes (max, high percentiles). Bootstrapping with larger sample sizes provides highly accurate estimates for both central tendency and variability, closely approximating the true population parameters.
